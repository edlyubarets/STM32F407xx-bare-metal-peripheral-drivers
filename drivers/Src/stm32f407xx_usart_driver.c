 ...
 *
 */
void USART_PClkCtrl(USART_RegDef_t *pUSARTx, uint8_t EnDi)
{
	if(EnDi == ENABLE)
	{
		if(pUSARTx == USART1)
 ...
 * @fn      		  - USART_Init
 *
 * @brief             - This function initializes the USARTx peripheral
 *
 ...
 * @fn				- USART_DeInit
 *
 * @brief			- This function resets the configuration of USARTx peripheral
 *
 ...
 * @fn				- USART_SendData
 *
 * @brief			- This function sends the data via the USARTx peripheral
 *
 ...
 *
 * @brief			- This function receives the data via the USARTx peripheral
 *
 * @param[in]		- USART peripheral handle structure
 * @param[in]		- base address of RX buffer
 * @param[in]		- length of data
 *
 * @return			- none
 *
 ...
 * @fn				- USART_SendDataIT
 *
 * @brief			- This function receives the data over the interrupt via the USARTx peripheral
 *
 * @param[in]		- USART peripheral handle structure
 * @param[in]		- base address of TX buffer
 * @param[in]		- length of data
 ...
 *
 * @brief			- This function configures the IRQ for USARTx peripheral
 *
 ...
 *
 * @brief			- This function configures the priority for IRQ of USARTx peripheral
 *
 * @param[in]		- Number of IRQ
 * @param[in]		- priority
 * @param[in]		-
 ...
 *
 * @brief			- This function handles the IRQ of USARTx peripheral
 *
 * @param[in]		- peripheral handle structure
 * @param[in]		-
 * @param[in]		-
 *
 * @return			- none
 ...
 *
 * @brief			- This returns the status of given flag
 *
 * @param[in]		- base address of usart peripheral
 * @param[in]		- flag name
 * @param[in]		-
 ...
 * @fn				- USART_ClearFlag
 *
 * @brief			- This functions clears the given flag bit in SR register
 *
 * @param[in]		- base address of usart peripheral
 * @param[in]		- flag name
 * @param[in]		-
